...
# Starting and stopping the refresh loop lives in the lifespan handler above,
# not in @app.on_event. The two are alternative APIs for the same thing and
# on_event is deprecated; keeping both would start the loop twice.
