...
from ecoguard.collection.hydrology_static import BASE_URL, REQUEST_TIMEOUT_SECONDS
from ecoguard.collection.hydrometric_stations import TOKEN_PATTERN, USER_AGENT
