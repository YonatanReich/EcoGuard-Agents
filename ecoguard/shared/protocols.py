...
from ecoguard.paths import PROTOCOLS

# The corpus is indexed by hazard: <protocols>/<hazard>/*.md, each with its
...
class ProtocolRetriever:
    ...
    Selecting a corpus:
        ``ProtocolRetriever(hazard="flood")`` reads the ``flood`` corpus.
