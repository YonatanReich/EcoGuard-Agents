...
from ecoguard.analyzers.non_emergency.air_pollution.settlement_ranking import SettlementSpatialRankingResult
from ecoguard.analyzers.non_emergency.air_pollution.transport_geometry import smallest_angular_difference_deg
