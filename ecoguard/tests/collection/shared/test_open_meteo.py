...
import ecoguard.collection.shared.open_meteo.observations as weather_module
from ecoguard.collection.base import service_area_cells
from ecoguard.collection.shared.open_meteo.observations import WeatherCollector, plan_fetches, records_from_batch
from ecoguard.collection.shared.open_meteo.client import HOURLY_VARIABLES, HourlyProviderError
