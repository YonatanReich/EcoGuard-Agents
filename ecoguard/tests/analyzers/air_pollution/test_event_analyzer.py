...
from ecoguard.analyzers.air_pollution.event_analyzer import AirPollutionNonEmergencyAnalyzer
...
from ecoguard.analyzers.air_pollution.analysis_adapter import (
...
def test_analyzer_stack_has_no_database_runtime_store_scheduler_or_planner_dependency():
    import ecoguard.analyzers.air_pollution.event_analyzer as analyzer_module
    import ecoguard.analyzers.air_pollution.analysis_adapter as adapter_module
