...
from ecoguard.tests.collectors.test_base_collector import _Recorder
from ecoguard.tests.collectors.pollution.test_ministry_air_quality_client import FakeSession, channel, routes_for, station
...
def test_failed_provider_result_is_a_failed_audit(monkeypatch):
    recorder = _Recorder(monkeypatch)
    instance = collector({17: [channel("CO", 1.0)]})
    from ecoguard.tests.collectors.pollution.test_ministry_air_quality_client import FakeResponse
