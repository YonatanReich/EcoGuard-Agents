...
from scripts.build_historical_negative_weather_features import (
    OUTPUT_PATH as NEGATIVE_WEATHER_PATH,
)


POSITIVE_WEATHER_PATH = Path(
    "data/generated/historical_fire_weather_features_2023_2026.csv"
)
OUTPUT_PATH = Path("data/generated/fire_prediction_ml_dataset_2023_2026.csv")
