...
DATASET_PATH = Path("data/generated/fire_prediction_ml_environmental_dataset_2023_2026.csv")
BASELINE_METRICS_PATH = Path("data/generated/ml/fire_prediction_metrics.json")
