...
from scripts.build_historical_environmental_features import coordinate_key


INPUT_PATH = Path("data/generated/fire_prediction_ml_environmental_dataset_2023_2026.csv")
OUTPUT_PATH = Path("data/generated/fire_prediction_ml_landcover_terrain_dataset_2023_2026.csv")
SOURCE_DIRECTORY = Path("data/generated/static_environmental_sources")
CACHE_PATH = Path("data/generated/historical_landcover_terrain_cache.json")
TIMEOUT_SECONDS = 60
MAX_ATTEMPTS = 4
