...
from agents.risk_analysis_agent import build_event_id, build_situational_facts
from services.protocol_retrieval_service import ProtocolRetriever

OUTPUT_DIR = Path("data/evaluation/fire_cases")
...
def assessment(
    *,
    ...
    from agents.risk_analysis_schemas import risk_level_for_score
