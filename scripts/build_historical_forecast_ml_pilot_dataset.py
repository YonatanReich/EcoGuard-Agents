...
from scripts.build_historical_forecast_risk_pilot import (
...
DATASET_PATH = Path("data/generated/fire_prediction_ml_landcover_terrain_dataset_2023_2026.csv")
GRID_PATH = Path("data/generated/fire_risk_grid.sqlite")
POSITIVE_CHECKPOINT = Path("data/generated/historical_fire_weather_checkpoint/candidates")
NEGATIVE_CHECKPOINT = Path("data/generated/historical_fire_negative_weather_checkpoint/candidates")
MANIFEST_PATH = Path("data/generated/fire_forecast_risk_pilot_manifest.csv")
SNAPSHOT_PLAN_PATH = Path("data/generated/fire_forecast_risk_pilot_snapshots.csv")
CACHE_PATH = Path("data/generated/forecast_risk_pilot_cache/forecast_runs.sqlite")
HORIZONS = (12, 6, 3)
