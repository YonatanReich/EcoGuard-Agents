...
from scripts.build_historical_fire_negative_samples import (
    FIRMS_INPUT,
    FirmsIncident,
    haversine_km,
...
INPUT_PATH = Path("data/generated/fire_prediction_ml_dataset_2023_2026.csv")
OUTPUT_PATH = Path("data/generated/fire_prediction_ml_environmental_dataset_2023_2026.csv")
ELEVATION_CACHE = Path("data/generated/historical_environmental_elevation_cache.json")
