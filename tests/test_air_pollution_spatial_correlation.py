...
from agents.air_pollution_spatial_enrichment import (
    LAYERS,
...
def test_modules_have_no_old_runtime_or_event_store_dependency():
    import agents.air_pollution_correlation as correlation_module
    import agents.air_pollution_spatial_enrichment as enrichment_module
