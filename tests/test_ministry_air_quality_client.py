...
from services.ministry_air_quality_client import (
    ACCESS_TOKEN_URL,
    GUEST_TOKEN_URL,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            channel("PM10", 10.0, status=2),
            [{"Id": 2, "Name": "Calib"}],
            "unusable_provider_status",
        ),
        (
            channel("PM10", 10.0, status=3),
            [{"Id": 3, "Name": "Down"}],
            "unusable_provider_status",
        ),
        (
            channel("PM10", 10.0, status=4),
            [{"Id": 4, "Name": "NoData"}],
            "unusable_provider_status",
        ),
        (
            channel("PM10", 10.0, status=5),
            [{"Id": 5, "Name": "InVld"}],
            "unusable_provider_status",
        ),
    ],
