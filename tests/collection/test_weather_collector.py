...
import ecoguard.collection.weather as weather_module
from ecoguard.collection.base import service_area_cells
from ecoguard.collection.weather import WeatherCollector, plan_fetches, records_from_batch
from services.open_meteo_hourly_client import HOURLY_VARIABLES, HourlyProviderError
