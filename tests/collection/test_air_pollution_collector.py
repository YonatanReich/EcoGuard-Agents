...
from collection.test_base_collector import _Recorder
from test_ministry_air_quality_client import FakeSession, channel, routes_for, station
...
def test_failed_provider_result_is_a_failed_audit(monkeypatch):
    recorder = _Recorder(monkeypatch)
    instance = collector({17: [channel("CO", 1.0)]})
    from test_ministry_air_quality_client import FakeResponse
