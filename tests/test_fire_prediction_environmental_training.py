...
from scripts.build_historical_environmental_features import ENVIRONMENTAL_FEATURES
from scripts.build_historical_fire_weather_features import FEATURE_FIELDS
from scripts.train_fire_prediction_environmental_models import (
    ABLATIONS,
    FULL_FEATURES,
...
from scripts.train_fire_prediction_models import FORBIDDEN_FEATURES, temporal_split
